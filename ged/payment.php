...
if (isset($_SESSION['ANNEESSCOLAIRE'])) {
 ...
 $query_rq_liste_eveleve = $dbh->query("SELECT FACTURE.*, INSCRIPTION.*, INDIVIDU.* FROM INSCRIPTION, FACTURE, INDIVIDU WHERE FACTURE.IDINSCRIPTION= INSCRIPTION.IDINSCRIPTION AND INSCRIPTION.IDINDIVIDU = INDIVIDU.IDINDIVIDU AND INSCRIPTION.IDANNEESSCOLAIRE=".$colname_rq_anne." AND INSCRIPTION.IDINDIVIDU IN (SELECT ideleve
FROM PARENT WHERE  PARENT.idParent = '".$colname_rq."')  ORDER BY FACTURE.IDFACTURE DESC");
...
<?php include('header.php'); ?>
   ...
   <tr>
      ...
      <td ><a href="jula.php"><i class="glyphicon  glyphicon-credit-card"></i></a></td>
