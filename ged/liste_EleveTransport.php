...
<table width="661" height="97" border="0" align="center" cellpadding="0" cellspacing="3">
  <tr >
    <td height="19" colspan="6" class="Titre"><?php echo 'Liste des éléves qui prennent les transports'; ?></td>
  </tr>
  <tr >
  ...
  <tr >
    ...
    <td align="left" valign="middle" class="textBrute"><?php echo $lib->nombre_form($row_rq_etudiant['MONTANT_TRANSPORT']); ?></td>
  </tr>
  <?php
