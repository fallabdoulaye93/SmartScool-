...
$nomClasse = $lib->securite_xss($_SESSION["CLASSE"]);
...
<page backtop="7mm" backbottom="7mm" backleft="10mm" backright="10mm" orientation="landscape">
    <table border="0" width="100%"  >
        <tr>
            ...
            <td  align="center" valign="middle"style="font-size: 10px !important; text-align: center !important"><strong><?php echo $_SESSION['SIGLE']; ?></strong><br/>
