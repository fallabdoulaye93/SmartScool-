...
$nomElev = base64_decode($lib->securite_xss($_GET['NOM']));
    ...
    <table width="50%" border="0" align="center">
       <tr>
           <td align="center" valign="middle" class="textBrute">
                  <strong><span style="font-size: 25px;">EMPLOI DU TEMPS DU <?= ($idPeriode == 1)?" PREMIER ":" SECOND "; ?> SEMESTRE DE : <b><?= $nomElev; ?></b> </span></strong>
             </td>
       </tr>
    </table>
<br/>
