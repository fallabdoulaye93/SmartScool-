...
$NIVEAUX = (isset($_GET['IDNIVEAU'])) ? str_replace("-", " ", base64_decode($lib->securite_xss($_GET['IDNIVEAU']))) : $_SESSION["IDNIVEAU"];
$_SESSION["idClasse"] = $idClasse;
$_SESSION["idPeriode"] = $idPeriode;
$_SESSION["NOM"] = $nomClasse;
$_SESSION["IDNIVEAU"] = $NIVEAUX;
...
function calendar($jour, $date_deb, $date_fin, $idPeriode, $idClasse){
    ...
    $query = "SELECT DETAIL_TIMETABLE.IDDETAIL_TIMETABLE as idDTT,DETAIL_TIMETABLE.JOUR_SEMAINE as jour,DETAIL_TIMETABLE.DATEDEBUT as debut,
              DETAIL_TIMETABLE.DATEFIN as fin,MATIERE.IDMATIERE as idmatiere,MATIERE.LIBELLE as libmatiere,SALL_DE_CLASSE.IDSALL_DE_CLASSE as idsalle,
              SALL_DE_CLASSE.NOM_SALLE as libsalle,INDIVIDU.IDINDIVIDU as idprof,INDIVIDU.PRENOMS as prenom,INDIVIDU.NOM as nom
...
$query_rq_matiere = $dbh->query("SELECT `IDMATIERE`, `LIBELLE`, `IDETABLISSEMENT` FROM `MATIERE` WHERE IDETABLISSEMENT = " . $colname_rq_etablissement." AND IDNIVEAU=".$NIVEAUX);

$query_rq_matiere2 = $dbh->query("SELECT `IDMATIERE`, `LIBELLE`, `IDETABLISSEMENT` FROM `MATIERE` WHERE IDETABLISSEMENT = " . $colname_rq_etablissement." AND IDNIVEAU=".$NIVEAUX);
...
$query_rq_prof = $dbh->query("SELECT DISTINCT INDIVIDU.IDINDIVIDU, `MATRICULE`, `NOM`, `PRENOMS`, `DATNAISSANCE`, `ADRES`, `TELMOBILE`, `TELDOM`, `COURRIEL`, `LOGIN`, `MP`, `CODE`, `BIOGRAPHIE`, `PHOTO_FACE`, `IDTYPEINDIVIDU`, `SEXE`, 
                                        `IDTUTEUR`, `LIEN_PARENTE`, `ANNEEBAC`, `NATIONNALITE`, `SIT_MATRIMONIAL`, `NUMID`, `IDSECTEUR`, `LIEU_TRAVAIL`, `PATHOLOGIE`, `ALLERGIE`, `MEDECIN_TRAITANT`, `FICHE_RECTO`, `FICHE_VERSO` 
                                        FROM `INDIVIDU` 
                                        ...
                                        AND CLASSROOM.IDNIVEAU=".$NIVEAUX);

$query_rq_prof2 = $dbh->query("SELECT DISTINCT INDIVIDU.IDINDIVIDU, `MATRICULE`, `NOM`, `PRENOMS`, `DATNAISSANCE`, `ADRES`, `TELMOBILE`, `TELDOM`, `COURRIEL`, `LOGIN`, `MP`, `CODE`, `BIOGRAPHIE`, 
                                        `PHOTO_FACE`, `IDTYPEINDIVIDU`, `SEXE`, `IDTUTEUR`, `LIEN_PARENTE`, `ANNEEBAC`, `NATIONNALITE`, `SIT_MATRIMONIAL`, `NUMID`, `IDSECTEUR`, `LIEU_TRAVAIL`, `PATHOLOGIE`, 
                                        `ALLERGIE`, `MEDECIN_TRAITANT`, `FICHE_RECTO`, `FICHE_VERSO` 
                                        FROM `INDIVIDU` 
                                        INNER JOIN RECRUTE_PROF ON RECRUTE_PROF.IDINDIVIDU=INDIVIDU.IDINDIVIDU 
                                        INNER JOIN CLASSE_ENSEIGNE ON CLASSE_ENSEIGNE.IDRECRUTE_PROF =RECRUTE_PROF.IDRECRUTE_PROF 
                                        INNER JOIN CLASSROOM ON CLASSROOM.IDCLASSROOM =CLASSE_ENSEIGNE.IDCLASSROM 
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?php if(!is_null($msg1)){  ?>
                        <div class="alert alert-danger">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <?php echo $lib->securite_xss($msg1); ?>
                        </div>
                    <?php } ?>
                                    ...
                                    <div class="panel-body">
                                        <fieldset>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <select class="validate[required] form-control" name="HEUREDEBUT" id="HEUREDEBUT">
                                                    <option value="">--Selectionner--</option>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <select class="validate[required] form-control"  name="HEUREFIN" id="HEUREFIN">
                                                    <option value="">--Selectionner--</option>
                                                    <option value="09:30:00">09:30</option>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="panel-body">
                                        ...
                                        <div class="alert1 alert-danger hidden" style="padding: 10px!important;">
                                            Veuillez vérifiez l'intervalle d'heure
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer" style="border-top-color: #2b4f89;">
                ...
                <script>
                    ...
                    function validCours(idJour,idHD,idHF) {
                        ...
                        var INTERVALLETEMPS = parseInt(heurfin[0]+heurfin[1]) - parseInt(heurdeb[0]+heurdeb[1]);
                        var elements = $("." + jour);

                        if (INTERVALLETEMPS == 1) {
