...
try
{
    $query_rq_niv = $dbh->query("SELECT IDNIVEAU, LIBELLE, IDETABLISSEMENT FROM NIVEAU WHERE IDETABLISSEMENT = " . $colname_rq_etablissement);
...
/*$query_rq_periode = $dbh->query("SELECT `IDPERIODE`, `NOM_PERIODE`, `DEBUT_PERIODE`, `FIN_FPERIODE`, `IDANNEESSCOLAIRE`, `IDETABLISSEMENT`
                                          FROM `PERIODE` 
    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form id="form1" name="form1" method="POST" action="ajouterEmploiTemps.php">
                    <fieldset>
                        <div class="row">
                        <div class="col-lg-4">
                                <label>CYCLE:</label>
                        ...
                        if(selectNiv!="" && IDPERIODE!="" && IDCLASSROOM!="") {
                            $.ajax({
                                ...
                                success: function (data) {
                                    data=JSON.parse(data);
                                   if(data==1){
                                       alert("Cette classe a déja un emploi du temps généré pour cette periode");
