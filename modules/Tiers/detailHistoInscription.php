...
$query_rq_individu = $dbh->query("SELECT INSCRIPTION.DATEINSCRIPT, INDIVIDU.MATRICULE, INDIVIDU.NOM, INDIVIDU.PRENOMS, INDIVIDU.TELMOBILE, INDIVIDU.IDINDIVIDU, INDIVIDU.PHOTO_FACE, INSCRIPTION.IDINSCRIPTION, INSCRIPTION.ETAT, CLASSROOM.LIBELLE 
                ...
                <!-- PAGE CONTENT WRAPPER -->
                  <div class="page-content-wrap">
                    ...
                    <div class="panel-heading">
                      <h3 style="color:#DD682B"> Les éléves inscrits en cycle <?php echo $lib->securite_xss(base64_decode($_GET['NIVEAU'])); ?>  </h3>
                     ...
                     <table id="customers2" class="table datatable">
                           ...
                           <?php foreach ($query_rq_individu->fetchAll() as $individu){ ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $lib->date_franc($individu['DATEINSCRIPT']); ?></td>
                                <td>
                                    <?php
                                    if($individu['ETAT'] == 1)
                                    {
                                        echo "<a href='modifInscription.php?idInscription=".base64_encode($individu['IDINSCRIPTION'])."&amp;IDSERIE=".$lib->securite_xss($_GET['IDSERIE'])."&amp;IDNIVEAU=".$lib->securite_xss($_GET['IDNIVEAU'])."&amp;IDINDIVIDU=".base64_encode($individu['IDINDIVIDU'])."'><i class='glyphicon glyphicon-edit'></i></a>";
                                    }
                                    else
                                    {
                                        echo "<i style='color: darkred;cursor: pointer' class='glyphicon glyphicon-remove'></i>";
                                    }
                                    ?>
                                </td>
                                ...
                                <td>
                                    ...
                                    if ($individu['ETAT'] == 1)
                                    {
                                        echo "<a href='#annulation' data-toggle='modal' data-id='".$individu['IDINSCRIPTION']."' data-toggle='tooltip' data-placement='bottom' title='ANNULER'><i style='color: green;cursor: pointer' class='glyphicon glyphicon-hand-left'></i></a>";
                                    }
                                    else
                                    {
                                        echo "<i style='color: darkred;cursor: pointer' class='glyphicon glyphicon-remove'></i>";
                                ...
                                <td>
                                    ...
                                    if ($individu['ETAT'] == 1)
                                    {
                                        echo "<a href='../../ged/inscription.php?idetablissement=".base64_encode($_SESSION['etab'])."&amp;idinscription=".base64_encode($individu['IDINSCRIPTION'])."&amp;IDINDIVIDU=".base64_encode($individu['IDINDIVIDU'])."'> <i class='glyphicon glyphicon-list'></i></a>";
                                    }
                                    else
                                    {
                                        echo "<i style='color: darkred;cursor: pointer' class='glyphicon glyphicon-remove'></i>";
