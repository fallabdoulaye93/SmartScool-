...
if (isset($_POST) && $_POST != null) {
    ...
    $query_rq_individu = $dbh->query("SELECT `IDINDIVIDU`, `MATRICULE`, `NOM`, `PRENOMS`, `DATNAISSANCE`, `ADRES`, `TELMOBILE`, `TELDOM`, `COURRIEL`, `LOGIN`, `MP`, `CODE`, `BIOGRAPHIE`, `PHOTO_FACE`, `IDETABLISSEMENT`, `IDTYPEINDIVIDU`, `SEXE`, `IDTUTEUR`, `ANNEEBAC`, `NATIONNALITE`, `SIT_MATRIMONIAL`, `NUMID`, `IDSECTEUR` FROM `INDIVIDU` WHERE IDINDIVIDU = " . $lib->securite_xss($_GET['idIndividu']));
...
<div class="page-content-wrap">
    ...
    <div class="row">
        ...
        <form action="modifIndividu.php" method="POST" enctype="multipart/form-data" id="form">
            <div class="row">
                <div class="col-xs-12">
