...
<head>
    ...
    <link rel="stylesheet" type="text/css" id="theme" href="../../js/plugins/fancybox/ekko-lightbox.min.css"/>
    ...
    <script language="javascript">
        ...
        function Active_classe() {
            var lvaleur = document.getElementById("TYPE_INDIVIDU").value;
            if (lvaleur == 8) {
                //alert(lvaleur);
                document.getElementById("LABCLASS").style.visibility = 'visible';
                document.getElementById("CLASSROOM").style.visibility = 'visible';
                document.getElementById("NIVEAU").style.visibility = 'visible';
                document.getElementById("LABNIVEAU").style.visibility = 'visible';
                document.getElementById("LABFILIERE").style.visibility = 'visible';
                document.getElementById("FILIERE").style.visibility = 'visible';


            }
            else {

                document.getElementById("LABCLASS").style.visibility = 'hidden';
                document.getElementById("CLASSROOM").style.visibility = 'hidden';
                document.getElementById("NIVEAU").style.visibility = 'hidden';
                document.getElementById("LABNIVEAU").style.visibility = 'hidden';
                document.getElementById("LABFILIERE").style.visibility = 'hidden';
                document.getElementById("FILIERE").style.visibility = 'hidden';
            }
        }
        ...
        function tuteur() {
            var type = document.getElementById("IDTYPEINDIVIDU").value;

            if (type == 8) {
                document.getElementById("tuteur").style.visibility = 'visible';
                document.getElementById("tuteur").style.display = 'block';
            }
            else {
                document.getElementById("tuteur").style.visibility = 'hidden';
                document.getElementById("tuteur").style.visibility = 'none';
            }
        }
        ...
        function tuteur2() {
            ...
            for (i = 0; i < document.form.type.length; i++) {
                if (document.form.type[i].checked) {
                    ...
                    if (type == "oui") {
                        document.getElementById("tuteur2").style.visibility = 'visible';
                        document.getElementById("tuteur2").style.display = 'block';

                        document.getElementById("tuteur3").style.visibility = 'hidden';
                        document.getElementById("tuteur3").style.visibility = 'none';
                    }
                    else {
                        document.getElementById("tuteur3").style.visibility = 'visible';
                        document.getElementById("tuteur3").style.display = 'block';

                        document.getElementById("tuteur2").style.visibility = 'hidden';
                        document.getElementById("tuteur2").style.visibility = 'none';
                    }
                }
            }
                ...
                <div class="profile">
                    ...
                    <div class="profile-data">
                        ...
                        <div class="profile-data-title"><?php echo $rs_user->profil; ?>
                            <p><a style="color: #ffffff;hover::blue;" href="../Parametrage/modifUserPwd.php">Changer mot de passe</a></p>
                        </div>
                        <div style="margin: 50px auto 0; width: 150px; color: white; font-weight: bolder;"
                            ...
                            <select name="annee_scolaire" id="annee_scolaire" onchange="mySelectValueChange();"
                                ...
                                <?php foreach ($annee_scolaire->fetchAll() as $oneAnnee) { ?>
                                    <option
                                        value="<?php echo $oneAnnee['IDANNEESSCOLAIRE']; ?>" <?php if ($oneAnnee['IDANNEESSCOLAIRE'] == $lib->securite_xss($_SESSION['ANNEESSCOLAIRE'])) echo "selected"; ?>><?php echo $oneAnnee['LIBELLE_ANNEESSOCLAIRE']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
            ...
            <?php  if ($profily == 1 || $lib->Acces_module($profily, 1) == 1) { ?>
                ...
                <li class="xn-openable active">
                    ...
                    <ul>
                        ...
                        <?php }  ?>
                        <?php if ($profily == 1 || $lib->Est_autoriser(44,$profily) == 1) { ?>
                            <li><a href="../Tiers/smsEleves.php"><span class="fa fa-paper-plane" aria-hidden="true"></span> Envoie SMS &eacute;léves</a></li>
                        <?php }  ?>

                        <?php if ($profily == 1 || $lib->Est_autoriser(44,$profily) == 1) { ?>
                            <li><a href="../Tiers/smsParents.php"><span class="fa fa-paper-plane" aria-hidden="true"></span> Envoie SMS parents</a></li>
                        <?php }  ?>
                        <?php if ($profily == 1 || $lib->Est_autoriser(44,$profily) == 1) { ?>
                            <li><a href="../Tiers/smsProfesseurs.php"><span class="fa fa-paper-plane" aria-hidden="true"></span> Envoie SMS professeurs</a></li>
                        <?php }  ?>
                    </ul>
                </li>
                ...
                <li class="xn-openable">
                    ...
                    <ul>
                        ...
                        <?php } if ($profily == 1 || $lib->Est_autoriser( 21,$profily) == 1) { ?>
                            ...
                            <li><a href="../Evaluations/GenebulletinNotesMensuel.php"><span class="glyphicon glyphicon-list-alt"></span>Generation bulletin notes mensuel </a></li>
        ...
        <ul class="x-navigation x-navigation-horizontal x-navigation-panel">
            ...
            <?php if (!isset($_SESSION['client'])) { ?>
                ...
                <li class="xn-icon-button pull-right"><br>
                    ...
                    <?php $nom = $lib->securite_xss($_SESSION['nom']);  $prenom = $lib->securite_xss($_SESSION['prenom']); ?>
