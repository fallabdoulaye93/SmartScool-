            ...
            <div class="panel-body">
                ...
                <form id="form_droit" name="form_droit" method="post" action="permissionTraite.php">
                    <table id="customers2" class="table datatable">
                        ...
                        <tbody>
                        <?
                        foreach ($rq_dictionnaire->fetchAll() as $module) {

                            ?>
                            <tr>

                                <td><input type="text" name="module[]" id="module"
                                           value="<?php echo $module['nomModule']; ?>" class="form-control" readonly>
                                </td>
                                <td>
                                    <input type="text" name="action[]" id="action"
                                           value="<?php echo $module['label']; ?>" class="form-control" readonly>
                                </td>

                                <td>
                                    <?php $restreint = $lib->Est_autoriser($module['idAction'], base64_decode($lib->securite_xss($_GET['idProfil']))); ?>

                                    <input type="checkbox" name="valide[]" <?php if ($restreint == 1) {
                                        echo "checked";
                                    } ?> value="<?php echo $module['idAction']; ?>" class="css-checkbox">
