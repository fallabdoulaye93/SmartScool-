...
$query_rq_salle = $dbh->query("SELECT SALL_DE_CLASSE.IDSALL_DE_CLASSE, SALL_DE_CLASSE.NOM_SALLE, SALL_DE_CLASSE.NBR_PLACES, TYPE_SALLE.TYPE_SALLE FROM SALL_DE_CLASSE, TYPE_SALLE WHERE SALL_DE_CLASSE.IDETABLISSEMENT = ".$colname_rq_salle." AND SALL_DE_CLASSE.IDTYPE_SALLE=TYPE_SALLE.IDTYPE_SALLE");
			     ...
			     <?php } ?>
                     ...
                     <table id="customers2" class="table datatable">
                         ...
                         <thead>
                            ...
                            <tbody>
                           <?
                            foreach ($query_rq_salle->fetchAll() as $salle){
