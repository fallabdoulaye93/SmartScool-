                ...
                <li class="xn-openable active">
                    ...
                    <ul>
                        <?php if ($profily == 1 || $lib->Est_autoriser(3,$profily) == 1) { ?>
                            ...
                            <li><a href="accueil.php"><span class="fa fa-heart"></span> Information etablissement</a></li>

                        <?php } if ($profily == 1 || $lib->Est_autoriser(1,$profily) == 1) { ?>

                            <li><a href="profile.php"><span class="fa fa-heart"></span> Gestion Profil</a></li>

                        <?php }  if ($profily == 1 || $lib->Est_autoriser(2,$profily) == 1) { ?>

                            <li><a href="utilisateurs.php"><span class="fa fa-heart"></span> Gestion utilisateur</a></li>

                        <?php }  if ($profily == 1 || $lib->Est_autoriser(11,$profily) == 1) { ?>

                            <li><a href="anneesScolaires.php"><span class="fa fa-heart"></span> Gestion des annees scolaires</a></li>

                        <?php }  if ($profily == 1 || $lib->Est_autoriser(49,$profily) == 1) { ?>

                            <li><a href="niveaux.php"><span class="fa fa-heart"></span> Gestion des cycles</a></li>

                            <li><a href="niv.php"><span class="fa fa-heart"></span> Gestion des niveaux</a></li>

                        <?php } if ($profily == 1 || $lib->Est_autoriser(12,$profily) == 1) { ?>

                            <li><a href="periodeScolaires.php"><span class="fa fa-heart"></span> Gestion des periodes scolaires</a></li>

                        <?php }  if ($profily == 1 || $lib->Est_autoriser(4,$profily) == 1) { ?>

                            <li><a href="filieres.php"><span class="fa fa-heart"></span> Gestion des séries</a></li>

                        <?php }  if ($profily == 1 || $lib->Est_autoriser(5,$profily) == 1) { ?>

                            <li><a href="modules.php"><span class="fa fa-heart"></span> Gestion des matiéres</a></li>

                        <?php }  if ($profily == 1 || $lib->Est_autoriser(48,$profily) == 1) { ?>

                            <li><a href="classes.php"><span class="fa fa-heart"></span> Gestion des classes</a></li>

                        <?php } if ($profily == 1 || $lib->Est_autoriser(8,$profily) == 1) { ?>
                            
                            <li><a href="typeSalle.php"><span class="fa fa-heart"></span> Type de salle</a></li>

                            <li><a href="salle.php"><span class="fa fa-heart"></span> Gestion des salles de cours</a></li>

                        <?php } if ($profily == 1 || $lib->Est_autoriser(7,$profily) == 1) { ?>

                            <li><a href="fraisInscription.php"><span class="fa fa-heart"></span> Gestion des frais d'inscription</a></li>

                            <li><a href="sectionTransport.php"><span class="fa fa-heart"></span> Section transport</a></li>

                            <li><a href="forfaitProf.php"><span class="fa fa-heart"></span> Forfait professeur</a></li>

                            <li><a href="banque.php"><span class="fa fa-heart"></span> Liste des banques</a></li>

                            <li><a href="modePaiement.php"><span class="fa fa-heart"></span> Mode de paiement</a></li>

                            <li><a href="secteur.php"><span class="fa fa-heart"></span> Secteur d'activités </a></li>

                        <?php } if ($profily == 1 || $lib->Est_autoriser(9,$profily) == 1) { ?>

                            <li><a href="joursFeries.php"><span class="fa fa-heart"></span> Gestion des vacances</a></li>

                        <?php } if ($profily == 1 || $lib->Est_autoriser(10,$profily) == 1) { ?>

                            <li><a href="reglementInterieur.php"><span class="fa fa-heart"></span> Réglement intérieur de l'école</a></li>
