...
$query_rq_typsalle = $dbh->query("SELECT `IDTYPE_SALLE`, `TYPE_SALLE`, `IDETABLISSEMENT` FROM `TYPE_SALLE` WHERE IDETABLISSEMENT = ".$colname_rq_typsalle." ORDER BY TYPE_SALLE ASC");
			     ...
			     <?php } ?>
                     ...
                     <table id="customers2" class="table datatable">
                         ...
                         <thead>
                           ...
                           <?php foreach ($query_rq_typsalle->fetchAll() as $salle){ ?>
