...
$query_rq_niveau_etab = $dbh->query("SELECT `ROWID`, `LIBELLE`, `NBRE_JOUR`, `MONTANT`, `IDETABLISSEMENT` FROM `FORFAIT_PROFESSEUR` WHERE ROWID = $colname_rq_niveau_etab");
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" name="NBRE_JOUR" id="NBRE_JOUR" required class="form-control"
                                               value="<?php echo $nbre_jour; ?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
