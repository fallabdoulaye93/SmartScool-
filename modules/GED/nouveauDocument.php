...
$query_rq_etudiant = $dbh->query("SELECT INDIVIDU.IDINDIVIDU, INDIVIDU.MATRICULE, INDIVIDU.NOM, INDIVIDU.PRENOMS, INDIVIDU.TELMOBILE 
                                            FROM INDIVIDU WHERE INDIVIDU.IDETABLISSEMENT = ".$colname_rq_etudiant." 
                                            AND INDIVIDU.IDINDIVIDU  
                                            IN(SELECT   INDIVIDU.IDINDIVIDU FROM INDIVIDU,INSCRIPTION WHERE INDIVIDU.IDINDIVIDU = INSCRIPTION.IDINDIVIDU ) 
