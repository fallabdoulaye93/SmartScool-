...
<head>
    <!-- META SECTION -->
    <title>SunuEcole - Gestion Etablissements Scolaires</title>
    ...
    <script type="text/javascript">
        function imprimer(idclasse) {
            ...
            window.location = "../../ged/releve_classe.php?idclasse=" + idclasse + "&id_periode=" + idperiode + "&idetablissement=" + idetablissement;
        }
        ...
        function imprimer2(IDELEVE) {
            ...
            window.location = "../../ged/releve_classe2.php?IDELEVE=" + IDELEVE + "&idclasse=" + idclasse + "&id_periode=" + idperiode + "&idetablissement=" + idetablissement;
        }
    </script>
