...
$query_rq_mensualite = $dbh->query("SELECT MENSUALITE.MONTANT, MENSUALITE.MOIS, MENSUALITE.IDINSCRIPTION as IDINS, INDIVIDU.IDINDIVIDU, INDIVIDU.MATRICULE,INSCRIPTION.*, INDIVIDU.NOM, INDIVIDU.PRENOMS, INDIVIDU.TELMOBILE, MENSUALITE.IDMENSUALITE FROM MENSUALITE, INSCRIPTION, INDIVIDU WHERE MENSUALITE.IDINSCRIPTION=INSCRIPTION.IDINSCRIPTION AND INSCRIPTION.IDINDIVIDU=INDIVIDU.IDINDIVIDU AND INSCRIPTION.IDETABLISSEMENT=".$colname_rq_mensualite." AND INSCRIPTION.IDANNEESSCOLAIRE=".$colname_rq_anne." GROUP BY INDIVIDU.IDINDIVIDU ORDER BY INDIVIDU.IDINDIVIDU DESC");
			     ...
			     <?php } ?>
                     ...
                     <table id="customers2" class="table datatable">
                         ...
                         <thead>
                            ...
                            <tbody>
                           <?php
                            foreach ($query_rq_mensualite->fetchAll() as $row_rq_mensualite){
                            ...
                            <tr>
                                ...
                                <td ><a href="../../ged/imprimer_histo.php?IDINDIVIDU=<?php echo $row_rq_mensualite['IDINDIVIDU']; ?>&amp;IDINSCRIPTION=<?php echo $row_rq_mensualite['IDINSCRIPTION']; ?>"><i class=" glyphicon glyphicon-print"></i></a></td>
