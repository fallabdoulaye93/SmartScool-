...
<?php include('header.php'); ?>
    ...
    <form id="form1" name="form1" method="post" action="facture_ok.php" >
        ...
        <div class="col-lg-5">
                                   ...
                                   <div class="col-lg-3"> <label class="control-label">ETUDIANT</label></div>
                                    <div class="col-lg-9">
                                       ...
                                       <?php foreach($query_rq_eleve->fetchAll() as $row_rq_eleve){?>
                                        <option value="<?php echo $row_rq_eleve['IDINSCRIPTION']; ?>"><?php echo $row_rq_eleve['MATRICULE']."  ".$row_rq_eleve['PRENOMS']."  ".$row_rq_eleve['NOM']; ?></option>
                                      <?php }?>
            ...
            <div class="col-lg-1">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="submit" class="btn btn-success" name="envoyer2" value="Envoyer"  />
                                    </div>
                                </div>
            </div>
