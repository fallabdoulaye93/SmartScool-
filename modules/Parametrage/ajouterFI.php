...
if (isset($_POST) && $_POST != null)
{
    ...
    $_POST['montant_total'] = (intval($_POST['MT_MENSUALITE']) * intval($_POST['dure'])) + intval($_POST['FRAIS_INSCRIPTION']) + intval($_POST['FRAIS_DOSSIER']) + intval($_POST['VACCINATION']) + intval($_POST['ASSURANCE']) + intval($_POST['FOURNITURE']);
