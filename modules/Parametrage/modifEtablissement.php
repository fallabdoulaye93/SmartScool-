...
$query_rq_etablissement = $dbh->query("SELECT IDETABLISSEMENT, NOMETABLISSEMENT_, SIGLE, ADRESSE, TELEPHONE, REGLEMENTINTERIEUR, VILLE, PAYS, DEVISE, FAX, MAIL, SITEWEB, LOGO, CAPITAL, FORM_JURIDIQUE, RC, NINEA, NUM_TV, PREFIXE, BP, TABLEAUHONNEUR 
                                                FROM ETABLISSEMENT 
                ...
                <div class="row">
                    <div class="col-lg-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="TABLEAUHONNEUR" name="TABLEAUHONNEUR" value="<?php echo $row_rq_etablissement->TABLEAUHONNEUR; ?>">
                            </div>
                        </div>
