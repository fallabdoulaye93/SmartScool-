...
try
{
    $query_Rq_frais_inscription = $dbh->query("SELECT NS.MT_MENSUALITE, NS.FRAIS_INSCRIPTION, N.IDNIVEAU, N.LIBELLE, NS.dure, NS.montant_total, NS.ID_NIV_SER, NS.FRAIS_DOSSIER, NS.VACCINATION, NS.UNIFORME, NS.ASSURANCE, NS.FRAIS_EXAMEN, NS.FRAIS_SOUTENANCE 
                                                          FROM NIVEAU_SERIE NS 
                                                          INNER JOIN NIVEAU N ON N.IDNIVEAU = NS.IDNIVEAU 
                                                          WHERE NS.IDETABLISSEMENT = " . $colname_Rq_frais_inscription . " 
                                                          ORDER BY NS.MT_MENSUALITE ASC");
