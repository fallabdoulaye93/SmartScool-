                    ...
                    <?php foreach ($profils as $profile) {
                        if ($profile->getEtat() == 1) {
                           ...
                           // $classe = "<span style='color: green;' class='glyphicon glyphicon-ok-circle'></span>";
                            $classe = "<i class='glyphicon glyphicon-ok' style='color: green !important;'></i>";
                        } else {
                            $action = "1";
                            //$classe = "<span style='color: darkred;' class='glyphicon glyphicon-ban-circle'></span>";
                            $classe = "<i class='glyphicon glyphicon-remove' style='color: red !important;'></i>";
                        }
                        ?>
                        <tr>
                            <td><?php echo $profile->getProfil(); ?></td>
                            <td <?php  if($profile->getEtat() == 1) echo 'style="color: green !important;"'; else echo 'style="color: red !important;"'?> align="center">

                                <?php  if($profile->getEtat() == 1) echo 'Activé'; else echo 'Désactivé'?>
