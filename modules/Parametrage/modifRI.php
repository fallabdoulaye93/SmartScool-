...
if(isset($_POST) && $_POST !=null)
{
    ...
    header("Location: reglementInterieur.php?msg=".$lib->securite_xss($msg)."&res=".$lib->securite_xss($res));
}
                    ...
                    <div class="row">
                        ...
                        <form  method="POST" action="modifRI.php">
                           <textarea name="REGLEMENTINTERIEUR" cols="150" rows="15" class="form-control" id="mytextarea" class="textbrute2"> <?php echo $ri; ?>
                            ...
                            <input type="hidden" name="IDETABLISSEMENT"  id="IDETABLISSEMENT" value="<?php echo $id; ?>" /><br>
