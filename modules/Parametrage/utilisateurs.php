            ...
            <div class="panel-body">
                ...
                <table id="customers2" class="table datatable">
                    ...
                    <tr>
                        ...
                        <?php } ?>
                        <?php if ($profily == 1 || ($lib->Est_autoriser(2, $profily) == 1)) { ?>
                            <th style="width: 100px; text-align: center !important;">Activer/Désactiver</th>
                        <?php } ?>
                        <?php if ($profily == 1 || ($lib->Est_autoriser(2, $profily) == 1)) { ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="number" name="telephone" id="telephone" required="required" class="form-control" placeholder="format 221XXXXXXXXX"/>
                                    </div>
                                </div>
                            </div>
