                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label>CYCLE</label>
                                    <div>
                                        <select name="IDNIVEAU" class="form-control selectpicker" data-live-search="true" id="selectNiv" onchange="controlButton1();controlButton()">
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label>SERIE</label>
                                    <div>
                                        <select name="IDSERIE" class="form-control"  id="selectSerie" onchange="controlButton_();" required>
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label>NIVEAU</label>
                                    <div>
                                        <select name="IDNIV" class="form-control"  id="selectNiveau" onchange="controlButton_();" required>
