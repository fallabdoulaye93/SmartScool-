...
try
{
    $query_rq_user_etab = $dbh->query("SELECT idUtilisateur, matriculeUtilisateur, codeUtilisateur, prenomUtilisateur, nomUtilisateur, telephone, adresse, email, login, 
                                                  password, idEtablissement, idProfil, dateCreation, userCreation, dateModification, userModification 
                                                  FROM  UTILISATEURS 
                                                  WHERE idUtilisateur = $colname_rq_user_etab");
                                ...
                                <div>
                                    <select name="idProfil" class="form-control selectpicker">
                                        ...
                                        <?php foreach ($profil as $profile) { ?>
                                            ...
                                            <option value=" <?php echo $profile->getIdProfil(); ?>" <?php if ($idProfil == $profile->getIdProfil()) echo "selected" ?>><?php echo $profile->getProfil(); ?> </option>
