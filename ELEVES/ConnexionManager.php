...
class ConnexionManager {
    ...
    public function Connecter($login,$motpass){
			...
			$query.= " WHERE ETABLISSEMENT.IDETABLISSEMENT= INDIVIDU.IDETABLISSEMENT AND INDIVIDU.IDTYPEINDIVIDU = 8 AND LOGIN=".$lib->GetSQLValueString($_POST['login'],"text")." and MP=".$lib->GetSQLValueString(md5($_POST['password']),"text");
