...
$query = "SELECT cl.IDCLASSROOM as idclass,cl.LIBELLE as libclass
          ...
          INNER JOIN RECRUTE_PROF r ON r.IDRECRUTE_PROF = ce.IDRECRUTE_PROF
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row">
                        <table id="customers2" class="table datatable table-striped">
                            ...
                            <tbody id="msg-recu" class="cache hidden">
                            <?php
                            ...
                            <tbody id="msg-env" class="vu" >
                            <?php
                                if(isset($tabMsgEnv) && count($tabMsgEnv)>0){
                                    foreach ($tabMsgEnv as $oneMsgEnv){ ?>
                                    <tr>
                                        <td style="text-align: center;"><img src="../img/icons/msg-send.png" width="31px" height="39px"/></td>
                                        <td><?= $lib->date_time_fr($oneMsgEnv->datemsg); ?></td>
                                        <td><?= $oneMsgEnv->libclass; ?></td>
                                        <td><?= $oneMsgEnv->objmsg; ?></td>
                                        <td><?= substr($oneMsgEnv->msg,0,50); ?> . . .</td>
                                        <td style="text-align: center;">
                                            <a href="#" onclick="affichageMSG('<?= "A : ".$oneMsgEnv->libclass; ?>', '<?= $oneMsgEnv->objmsg; ?>', '<?= $oneMsgEnv->idmsg; ?>', '<?= $oneMsgEnv->idmsg_dest; ?>')" >
                                                <i id="<?= $oneMsgEnv->idmsg_dest; ?>" style="font-size: 25px;" class="glyphicon glyphicon-eye-open"></i>
                                            </a>
                                        </td>
                                    </tr>
                                <?php }
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer" style="border-top-color: #2b4f89;">
                        ...
                        <button class="btn btn-sm btn-warning text-white" type="button" data-dismiss="modal"><b>Annuler</b>  </button>
                    </div>
                </div>
            </div>
        </div>
