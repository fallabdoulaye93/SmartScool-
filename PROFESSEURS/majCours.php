...
if (isset($_GET['IDINDIVIDU'])) {
    $colname_rq_classe = $lib->securite_xss($_GET['IDINDIVIDU']);
}
...
FROM ANNEESSCOLAIRE WHERE IDANNEESSCOLAIRE=" . $coln_anne_rq_classe);
...
$query_rq_classe = $dbh->query("SELECT rp.IDRECRUTE_PROF, ce.IDCLASSROM, cl.LIBELLE 
                                        ...
                                        AND rp.IDINDIVIDU =" .$idprof . " 
                                        GROUP BY cl.IDCLASSROOM");



$query_rq_salle_classe = $dbh->query("SELECT * FROM SALL_DE_CLASSE WHERE IDETABLISSEMENT = " .$idetab);
...
AND RECRUTE_PROF.IDINDIVIDU=" . $idprof);


$query_rq_profeseur = $dbh->query("SELECT * FROM INDIVIDU WHERE IDINDIVIDU = " .$idprof);
                    ...
                    <fieldset class="cadre">
                        ...
                        <form action="validerFicheEvaluation.php" method="post" name="form1" id="form1">
                            ...
                            <div class="col-lg-12">
                                ...
                                <textarea name="CONTENUCOURS" id="mytextarea"></textarea>
                            </div>

                            <input type="hidden" name="IDINDIVIDU" value="<?php echo $idprof ; ?>"/>
